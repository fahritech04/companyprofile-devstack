...
<section class="min-h-[60vh] flex items-center pt-28 pb-20 relative overflow-hidden" style="background: linear-gradient(180deg, #060e1f, #0a1628);">
    ...
    <div class="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-gray-950 to-transparent" style="background: linear-gradient(to top, #040b18, transparent);"></div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="card-dark p-8" data-aos="fade-right">
                ...
                <form class="space-y-5">
                    <div>
                        <label for="name" class="block text-gray-300 font-medium mb-2 text-sm"><?= lang('App.full_name') ?></label>
                        <input type="text" id="name" name="name" class="form-input-dark w-full">
                    </div>
                    <div>
                        <label for="email" class="block text-gray-300 font-medium mb-2 text-sm"><?= lang('App.email') ?></label>
                        <input type="email" id="email" name="email" class="form-input-dark w-full">
                    </div>
                    <div>
                        <label for="subject" class="block text-gray-300 font-medium mb-2 text-sm"><?= lang('App.subject') ?></label>
                        <input type="text" id="subject" name="subject" class="form-input-dark w-full">
                    </div>
                    <div>
                        <label for="message" class="block text-gray-300 font-medium mb-2 text-sm"><?= lang('App.message') ?></label>
                        <textarea id="message" name="message" rows="5" class="form-input-dark w-full resize-none"></textarea>
                    </div>
            ...
            <div class="space-y-6" data-aos="fade-left">
                ...
                <div class="card-dark p-6 group">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <a href="tel:+6281214240287" class="text-gray-400 text-sm hover:text-blue-400 transition-colors">+62 812 1424 0287</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-dark p-6 group">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:info@dev-stack.id" class="text-gray-400 text-sm hover:text-blue-400 transition-colors">info@dev-stack.id</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-dark p-6 text-center">
                    ...
                    <div class="flex justify-center space-x-3">
                        <a href="https://facebook.com/devstack" target="_blank" class="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-xl flex items-center justify-center transition-all border border-white/5 hover:border-blue-500/30 group">
                            <svg class="w-5 h-5 text-gray-500 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="https://twitter.com/devstack" target="_blank" class="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-xl flex items-center justify-center transition-all border border-white/5 hover:border-blue-500/30 group">
                            <svg class="w-5 h-5 text-gray-500 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                        </a>
                        <a href="https://instagram.com/devstack" target="_blank" class="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-xl flex items-center justify-center transition-all border border-white/5 hover:border-blue-500/30 group">
                        ...
                        <a href="https://linkedin.com/company/devstack" target="_blank" class="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-xl flex items-center justify-center transition-all border border-white/5 hover:border-blue-500/30 group">
...
<section class="py-24 relative" style="background: linear-gradient(180deg, #040b18, #060e1f);">
    <div class="glow-orb" style="width:400px;height:400px;background:radial-gradient(circle,rgba(37,99,235,.06),transparent 70%);top:20%;left:-8%;filter:blur(80px);"></div>
                ...
                <div class="card-dark overflow-hidden">
                    <div class="h-96 w-full relative">
                        <iframe
                            ...
                            width="100%" height="100%" style="border:0;filter:brightness(0.8) contrast(1.1) saturate(0.8);" allowfullscreen="" loading="lazy"
                    ...
                    <div class="p-6 border-t border-white/5">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">Lengkong, Kec. Bojongsoang, Kab. Bandung, Jawa Barat 40257</p>
                            </div>
                            <div class="flex gap-3">
                                <a href="https://maps.google.com/maps?q=Gg.+PGA+No.106,+Lengkong,+Kec.+Bojongsoang,+Kabupaten+Bandung" target="_blank" class="btn-glow text-sm px-5 py-2.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                                    <span><?= lang('App.open_maps') ?></span>
                                </a>
                                <a href="https://www.google.com/maps/dir/?api=1&destination=Gg.+PGA+No.106,+Lengkong,+Kec.+Bojongsoang,+Kabupaten+Bandung" target="_blank" class="btn-glass text-sm px-5 py-2.5">
                ...
                <div class="card-dark p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="text-white text-sm font-medium mb-1"><?= lang('App.accessibility_text') ?></h4>
                                <p class="text-gray-400 text-xs leading-relaxed">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="text-white text-sm font-medium mb-1"><?= lang('App.nearby_facilities_text') ?></h4>
                                <p class="text-gray-400 text-xs leading-relaxed">
