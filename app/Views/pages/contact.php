    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 w-full">
        <div class="text-center space-y-12 max-w-5xl mx-auto" data-aos="fade-up">
            ...
            <div class="inline-flex items-center px-5 py-2 rounded-full bg-white/80 border border-blue-100 shadow-sm backdrop-blur-md mb-4 hover:scale-105 transition-transform duration-300 cursor-default">
                ...
                <span class="text-sm text-blue-900 font-semibold tracking-wide uppercase"><?= lang('App.lets_connect') ?></span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-6 pt-8">
                <a href="#contact-form" class="group relative px-8 py-4 bg-blue-600 text-white rounded-xl font-semibold shadow-lg shadow-blue-500/30 hover:shadow-blue-600/40 hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <a href="tel:+6281214240287" class="group px-8 py-4 bg-white/60 backdrop-blur-md text-slate-700 border border-white/50 rounded-xl font-semibold shadow-sm hover:bg-white/80 hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex items-center justify-center">
            ...
            <div class="space-y-8" data-aos="fade-left">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                    ...
                    <div class="card-enterprise p-8 text-center hover-lift group">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            <a href="tel:+6281214240287" class="hover:text-green-600 transition-colors">
                                +62 812 1424 0287
                            </a>
                        </p>
                    </div>
                    ...
                    <div class="card-enterprise p-8 text-center hover-lift group">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            <a href="mailto:info@dev-stack.id" class="hover:text-purple-600 transition-colors">
                                info@dev-stack.id
                            </a>
                        </p>
                    </div>
                ...
                <div class="card-enterprise p-8 text-center hover-lift">
                    ...
                    <div class="flex justify-center space-x-6">
                        <a href="https://facebook.com/devstack" target="_blank" class="group">
                        ...
                        <a href="https://twitter.com/devstack" target="_blank" class="group">
                        ...
                        <a href="https://instagram.com/devstack" target="_blank" class="group">
                        ...
                        <a href="https://linkedin.com/company/devstack" target="_blank" class="group">
