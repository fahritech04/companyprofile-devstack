...
<section class="min-h-[60vh] flex items-center pt-28 pb-20 relative overflow-hidden"
    ...
    <canvas id="particle-network-about" class="absolute inset-0 w-full h-full opacity-30"></canvas>
...
<section class="py-24 relative" style="background: linear-gradient(180deg, #040b18, #060e1f, #040b18);">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-8">
                <div class="card-dark p-6 group hover:border-blue-500/30 transition-all duration-500"
                    data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
                    <div class="flex items-start space-x-5">
                        <div
                            class="icon-box-dark flex-shrink-0 group-hover:shadow-lg group-hover:shadow-blue-500/20 transition-all duration-500">
                        ...
                        <div>
                            <h3
                                class="text-white font-bold text-lg mb-2 group-hover:text-blue-300 transition-colors duration-300">
                                <?= lang('App.innovation_excellence_title') ?></h3>
                            <p class="text-gray-400 text-sm leading-relaxed">
                                <?= lang('App.innovation_excellence_desc') ?></p>
                        </div>
                    </div>
                </div>
                <div class="card-dark p-6 group hover:border-blue-500/30 transition-all duration-500"
                    data-aos="fade-right" data-aos-delay="200" data-aos-duration="700">
                    <div class="flex items-start space-x-5">
                        <div
                            class="icon-box-dark flex-shrink-0 group-hover:shadow-lg group-hover:shadow-blue-500/20 transition-all duration-500">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3
                                class="text-white font-bold text-lg mb-2 group-hover:text-blue-300 transition-colors duration-300">
                                <?= lang('App.client_centric_title') ?></h3>
                            <p class="text-gray-400 text-sm leading-relaxed"><?= lang('App.client_centric_desc') ?></p>
                        </div>
                    </div>
                </div>
                <div class="card-dark p-6 group hover:border-blue-500/30 transition-all duration-500"
                    ...
                    <div class="flex items-start space-x-5">
                        ...
                        <div>
                            <h3
                                class="text-white font-bold text-lg mb-2 group-hover:text-blue-300 transition-colors duration-300">
                                <?= lang('App.global_impact_title') ?></h3>
                            <p class="text-gray-400 text-sm leading-relaxed"><?= lang('App.global_impact_desc') ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-dark p-8 hover:border-blue-500/30 transition-all duration-500" data-aos="fade-left"
                ...
                <div class="flex items-center space-x-3 mb-8">
                    ...
                    <h3 class="text-xl font-bold text-white"><?= lang('App.why_choose_title') ?></h3>
                </div>
                <div class="space-y-5">
                    <?php $items = ['proven_track_record', 'expert_diverse_team', 'customized_solutions', 'continuous_innovation']; ?>
                    <?php foreach ($items as $idx => $item): ?>
                        <div class="flex items-center space-x-4 group/item" data-aos="fade-up"
                            data-aos-delay="<?= 300 + ($idx * 100) ?>" data-aos-duration="600">
                            <div
                                class="w-8 h-8 bg-blue-500/10 border border-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover/item:bg-blue-500/20 group-hover/item:border-blue-500/40 transition-all duration-300">
                            ...
                            <span
                                class="text-gray-300 text-sm group-hover/item:text-white transition-colors duration-300"><?= lang('App.' . $item) ?></span>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
