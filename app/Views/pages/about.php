    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 w-full">
        <div class="text-center space-y-8 max-w-4xl mx-auto reveal">
            ...
            <div class="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto pt-6">
                <div class="glass-card px-8 py-5 text-center group">
                    <span
            ...
            <div class="space-y-8">
                <div class="glass-card p-6 group">
                    <div class="flex items-start space-x-5">
                        ...
                        <div>
                            <h3 class="text-white font-bold text-lg mb-2"><?= lang('App.innovation_excellence_title') ?></h3>
                            <p class="text-gray-400 text-sm leading-relaxed"><?= lang('App.innovation_excellence_desc') ?></p>
                        </div>
                    </div>
                </div>
                <div class="glass-card p-6 group">
                    <div class="flex items-start space-x-5">
                        ...
                        <div>
                            <h3 class="text-white font-bold text-lg mb-2"><?= lang('App.client_centric_title') ?></h3>
                ...
                <div class="glass-card p-6 group">
                    <div class="flex items-start space-x-5">
                        ...
                        <div>
                            <h3 class="text-white font-bold text-lg mb-2"><?= lang('App.global_impact_title') ?></h3>
