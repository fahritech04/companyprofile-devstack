    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 hover:shadow-2xl transition-shadow">
                ...
                <button class="mt-4 block w-full bg-green-600 text-white text-center py-3 rounded-2xl hover:bg-green-700 transition-colors">
                    View Files
                </button>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 hover:shadow-2xl transition-shadow">
                ...
                <button class="mt-4 block w-full bg-purple-600 text-white text-center py-3 rounded-2xl hover:bg-purple-700 transition-colors">
                    View Activity
                </button>
            </div>
        </div>
        ...
        <div class="mt-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl shadow-xl p-8 text-white">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <button class="bg-white text-blue-600 px-6 py-3 rounded-2xl font-semibold hover:bg-blue-50 transition-colors">
                        Start Tutorial
                    </button>
                </div>
            </div>
