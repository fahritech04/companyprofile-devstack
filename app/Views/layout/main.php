        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-20 transition-all duration-300" id="navbar-container">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center space-x-3 group">
                        <img src="<?= base_url('images/devstack_logo.svg') ?>" alt="DevStack"
                            class="w-12 h-12 md:w-14 md:h-14 transition-transform duration-300 group-hover:scale-105" loading="eager">
                    </a>
                </div>
                ...
                <div class="md:hidden flex items-center">
                    <button class="mobile-menu-button w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center border border-blue-500/15 transition-colors hover:bg-blue-500/20">
            ...
            <div class="mobile-menu hidden md:hidden mobile-menu-dark rounded-b-2xl">
                <div class="px-4 py-6 space-y-1">
                    <a href="/" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-blue-500/10 rounded-xl transition-all duration-300 font-medium">Home</a>
                    <a href="/about" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-blue-500/10 rounded-xl transition-all duration-300 font-medium">About</a>
                    <a href="/services" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-blue-500/10 rounded-xl transition-all duration-300 font-medium">Services</a>
                    <a href="/portfolio" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-blue-500/10 rounded-xl transition-all duration-300 font-medium">Portfolio</a>
                    <a href="/contact" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-blue-500/10 rounded-xl transition-all duration-300 font-medium">Contact</a>
            ...
            <div class="py-12 border-b border-white/5">
                <div class="max-w-2xl mx-auto text-center">
                    ...
                    <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        <input type="email" placeholder="<?= lang('App.enter_email') ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div class="space-y-5">
                        <div class="flex items-center space-x-3">
                            <img src="<?= base_url('images/devstack_logo.svg') ?>" alt="DevStack" class="w-10 h-10">
                            <h3 class="text-xl font-bold text-white">DevStack</h3>
                        </div>
                        ...
                        <div class="flex space-x-3">
                            <a href="https://facebook.com/devstack" target="_blank"
                                ...
                                <svg class="w-4 h-4 text-gray-500 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Services -->
                    <div class="space-y-4">
                        <h4 class="text-sm font-semibold text-white uppercase tracking-wider"><?= lang('App.services_footer_title') ?></h4>
                        <ul class="space-y-3">
                            <li><a href="<?= base_url('services') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm"><?= lang('App.web_development') ?></a></li>
                            <li><a href="<?= base_url('services') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm"><?= lang('App.mobile_apps') ?></a></li>
                            <li><a href="<?= base_url('services') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm"><?= lang('App.cloud_solutions') ?></a></li>
                            <li><a href="<?= base_url('services') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm"><?= lang('App.consulting') ?></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <ul class="space-y-3">
                            <li><a href="<?= base_url('about') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">About Us</a></li>
                            <li><a href="<?= base_url('portfolio') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">Our Work</a></li>
                            <li><a href="#careers" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">Careers</a></li>
                            <li><a href="<?= base_url('contact') ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">Contact Us</a></li>
                        </ul>
                    </div>

                    <!-- Contact -->
                    <div class="space-y-4">
                        <h4 class="text-sm font-semibold text-white uppercase tracking-wider"><?= lang('App.contact') ?></h4>
                        <div class="space-y-3">
            ...
            <div class="border-t border-white/5 py-6">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div class="flex space-x-6 text-xs">
                        <a href="#privacy" class="text-gray-500 hover:text-blue-400 transition-colors">Privacy Policy</a>
                        <a href="#terms" class="text-gray-500 hover:text-blue-400 transition-colors">Terms of Service</a>
