        ...
        <div class="panel p-6">
            ...
            <div class="space-y-3">
                <?php foreach ($milestones as $ms): ?>
                    <div class="flex items-center gap-4 p-3 rounded-lg bg-white/[0.02]">
                        <div class="flex-1">
        ...
        <?php if (!empty($revisions)): ?>
            <div class="panel p-6">
                ...
                <?php foreach ($revisions as $rev): ?>
                    <div class="p-3 rounded-lg bg-white/[0.02] mb-3">
                        <div class="flex items-center justify-between mb-2">
            ...
            <div class="panel p-6">
                ...
                <?php foreach ($assets as $asset): ?>
                    <a href="<?= base_url($asset['file_path']) ?>" target="_blank"
                        class="flex items-center gap-2 py-2 text-sm text-gray-300 hover:text-blue-400 border-b border-white/[0.03] last:border-0">
