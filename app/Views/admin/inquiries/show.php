...
<div class="max-w-3xl animate-fade-in">
    <div class="panel p-6 lg:p-8 card-shine">
        ...
        <?php if ($inquiry['subject']): ?>
            <div class="mb-5 animate-fade-in animate-delay-1">
        ...
        <div class="mb-8 animate-fade-in animate-delay-1">
            ...
            <div class="bg-white/[0.02] border border-white/[0.05] rounded-xl p-5 card-shine">
                <p class="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap"><?= esc($inquiry['message']) ?></p>
            </div>
        </div>

        <!-- Actions -->
        <div class="flex items-center gap-3 pt-6 border-t border-white/[0.06] animate-fade-in animate-delay-2">
            <a href="mailto:<?= esc($inquiry['email']) ?>?subject=Re: <?= esc($inquiry['subject'] ?? 'Your Inquiry') ?>"
                class="btn-primary transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5">
            ...
            <?php if ($inquiry['phone']): ?>
                <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $inquiry['phone']) ?>" target="_blank"
                    class="btn-secondary transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/20 hover:-translate-y-0.5">
            ...
            <?php endif; ?>
            <a href="<?= base_url('admin/inquiries') ?>" class="btn-secondary ml-auto transition-all hover:shadow-lg hover:shadow-blue-500/10">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
