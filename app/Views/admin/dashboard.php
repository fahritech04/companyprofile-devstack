    ...
    <div class="stat-card" style="--accent-color: #10b981">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-white leading-none">Rp
    ...
    <div class="stat-card" style="--accent-color: #3b82f6">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white leading-none"><?= $activeOrders ?? 0 ?></p>
    ...
    <div class="stat-card" style="--accent-color: #f59e0b">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white leading-none"><?= $pendingInvoices ?? 0 ?></p>
    ...
    <div class="stat-card" style="--accent-color: #ef4444">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white leading-none"><?= $pendingTickets ?? 0 ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-5 mb-8">
    ...
    <a href="<?= base_url('admin/tickets') ?>"
        class="panel p-5 group hover:border-red-500/20 transition-all duration-300 flex items-center gap-4">
        <div
