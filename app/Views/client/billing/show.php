...
<a href="/client/billing" class="text-sm text-gray-400 hover:text-blue-400 flex items-center gap-2 mb-6">
    ...
    <div class="card-portal p-6">
        ...
        <div class="space-y-4 mb-6">
            ...
            <div class="flex justify-between py-3 border-b border-white/5">
                ...
                <span class="text-2xl font-bold text-blue-400">Rp
        ...
        <?php if ($invoice['status'] === 'unpaid'): ?>
            <div class="bg-blue-500/5 border border-blue-500/10 rounded-xl p-4 mb-4">
        ...
        <?php if ($invoice['payment_proof']): ?>
            <div class="bg-green-500/5 border border-green-500/10 rounded-xl p-4">
                ...
                <a href="<?= base_url($invoice['payment_proof']) ?>" target="_blank"
                    class="text-blue-400 text-sm hover:underline mt-2 inline-block">Lihat Bukti →</a>
            </div>
        <?php endif; ?>
    </div>
